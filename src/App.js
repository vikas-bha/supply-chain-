...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const networkId = await this.web3.eth.net.getId(); // 5777 for ganache
  ...
  listenToPaymentEvent = () => {
    ...
    console.log(item);
    alert("Item " + item._identifier + " was paid, deliver it now!"); // will actually name the pbject this function is used to deliver the project
    };
    console.log(evt);
    });
    }
